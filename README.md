...
| **User Interaction**   | **Unified Tkinter Frontend**.                              | Uses a single local GUI entry point (`app.py`) to configure KiCad export, component selection, datasheet handling, and execution of the Python STPA pipeline.                                                                                        |
...
| **Pipeline Ingestion**       | Loads KiCad `.net` files through `pipeline/src/ingestion`, applies ignored-part topology transforms, and derives connection pairs for analysis.                                                     |
...
| **Frontend App**             | `app.py` provides the sole user-facing wrapper for the pipeline.                                                                                                                                   |
